...
public class ItemsHandlerTest {
    ...
    public void getAllItems_approach1() {
        webTestClient
                .get()
                .uri(AppConstants.ITEM_FUNC_ENDPOINT_V1)
                .exchange()
                .expectStatus().isOk()
    ...
    public void getItemById() {
        webTestClient
                .get()
                .uri(AppConstants.ITEM_FUNC_ENDPOINT_V1.concat("/{id}"), "5")
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void getItemById_notFound() {
        webTestClient
                .get()
                .uri(AppConstants.ITEM_FUNC_ENDPOINT_V1.concat("/{id}"), "55")
                .exchange()
    ...
    public void updateItem() {
        ...
        webTestClient
                .put()
                .uri(AppConstants.ITEM_FUNC_ENDPOINT_V1.concat("/{id}"), "6")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    public void updateItem_notFound() {
        ...
        webTestClient
                .put()
                .uri(AppConstants.ITEM_FUNC_ENDPOINT_V1.concat("/{id}"), "10")
                .contentType(MediaType.APPLICATION_JSON)
